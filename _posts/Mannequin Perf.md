...
![](johanna-pettersson-vtmjustice-sidemission-johannapettersson-08.jpg)  
...
![](Pasted%20image%2020251207225905.png)
...
![](Pasted%20image%2020251209143334.png)
...
![](com.FastTravelGames.Mannequin-20240318-110237.jpg)  
...
![[Slides-optimization-2.png|345]]![[Slides-optimization-1.png|345]]
...
![](Pasted%20image%2020251207225508.png)
...
![](Pasted%20image%2020251207225216.png)
...
![](Pasted%20image%2020251210173654.png)
...
**In reality, this was a long chain of small fixes that added up. I have only covered a fraction of them here. Different culling solutions, instancing, LOD tuning, detail modes, CPD, color atlases, and, most importantly, engineering taking the time to turn Snow Occlusion into a proper tool instead of a quick fix.**

I hope this post was interesting and maybe gave you a few ideas on how you can keep performance under control in your own projects. If nothing else, I hope it shows that you do not need one big trick, just a lot of small decisions that all pull in the same direction.